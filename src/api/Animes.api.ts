...
export class AnimesApi{
    ...
    private addRotas() {
        this.api.addRota('/anime', 'POST', this.animeController.salvar.bind(this.animeController))
        this.api.addRota('/anime', 'GET', this.animeController.listar.bind(this.animeController))
        this.api.addRota('/anime/:id', 'GET', this.animeController.buscarPorId.bind(this.animeController))
        this.api.addRota('/anime/:id', 'DELETE', this.animeController.deletar.bind(this.animeController))
        this.api.addRota('/anime/:id', 'PUT', this.animeController.atualizar.bind(this.animeController))
    }
}